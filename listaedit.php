...
<table border="1" width="100%" align="left" > 
 <tr> 
  ...
  <td><table  border="1" width="100%"> 
      ...
      <?php if($idalumno==$id){ ?>
        <td><?php echo $row['nombre']; ?><a href="lista.php"><img align="right" src="images/cancelar.png" width="20px" height="20px" /></a></td>
      <?php }else{ ?>
      ...
      <td><table  border="1" width="100%"> 
       ...
       <tr> 
          ...
          <!--empieza primer if--><?php if($idalumno == $id){ ?>
       	...
       	<td align="center" height="50" width="50" bgcolor="red"><?php echo $dias[$i];  ?><form method="POST"  id="edit" action="<?php echo "lista.php?res=3&id=" . $id ."&not=" . $not ?>"><input type="text" name="asist" size="1"><input type="submit"  value="Editar" id="edit" size="1"><font size="1"></font></form></td>
