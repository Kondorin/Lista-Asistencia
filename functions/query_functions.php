...
function insert_dia($dia){
  ...
  if ($result) {
    ...
    header('Location: ../maestro/lista.php');
...
function insert_alumno($nombre,$cont){
 ...
 $sql = "INSERT INTO calificacion ";
  ...
  if ($result) {
    ...
    header('Location: ../maestro/grupo1.php');
...
$arrayencoded = json_encode($array);
  ...
  $sql = "UPDATE calificacion SET asistencia =" . "'$arrayencoded' where id=" . $id;
  $result = mysqli_query($db, $sql);
   //$datos = mysqli_fetch_assoc($alumnos);
}
...
function editar_tarea($id,$not, $newcal){
  ...
  $sql = "UPDATE calificacion SET tareas =" . "'$array'" . "where id=" . $id;
  $result = mysqli_query($db, $sql);
...
function editar_examen($id,$noe, $newcal){
  ...
  $sql = "UPDATE calificacion SET examenes =" . "'$array'" . "where id=" . $id;
  $result = mysqli_query($db, $sql);
...
function editar_asistencia($id,$not, $newasist){
  ...
  $sql = "UPDATE calificacion SET asistencia =" . "'$array'" . "where id=" . $id;
  $result = mysqli_query($db, $sql);
...
$sql = "UPDATE calificacion SET tareas = null";
