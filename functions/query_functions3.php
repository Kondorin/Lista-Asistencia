...
function insert_dia($dia){
  ...
  if ($result) {
    ...
    header('Location: ../maestro/lista3.php');
...
function insert_alumno($nombre,$cont){
 ...
 $sql = "INSERT INTO calificacion3 ";
  ...
  if ($result) {
    ...
    header('Location: ../maestro/grupo3.php?');
...
$arrayencoded = json_encode($array);
  ...
  $sql = "UPDATE calificacion3 SET tareas =" . "'$arrayencoded' where id=" . $id;
  $result = mysqli_query($db, $sql);
   $datos = mysqli_fetch_assoc($alumnos);
...
$arrayencoded = json_encode($array);
  ...
  $sql = "UPDATE calificacion3 SET asistencia =" . "'$arrayencoded' where id=" . $id;
  $result = mysqli_query($db, $sql);
   //$datos = mysqli_fetch_assoc($alumnos);
}
...
function editar_tarea($id,$not, $newcal){
  ...
  $sql = "UPDATE calificacion3 SET tareas =" . "'$array'" . "where id=" . $id;
  $result = mysqli_query($db, $sql);
...
function editar_examen($id,$noe, $newcal){
  ...
  $sql = "UPDATE calificacion3 SET examenes =" . "'$array'" . "where id=" . $id;
  $result = mysqli_query($db, $sql);
...
function editar_asistencia($id,$not, $newasist){
  ...
  $sql = "UPDATE calificacion3 SET asistencia =" . "'$array'" . "where id=" . $id;
  $result = mysqli_query($db, $sql);
...
$sql = "UPDATE calificacion3 SET tareas = null";
...
$sql = "truncate table calificacion3";
