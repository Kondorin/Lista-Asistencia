...
<!--botones-->
      ...
      <form action="lista.php?res=1"  method="post" enctype="multipart/form-data" style="float: left">
      <dl>
    ...
    <form action="borrar.php?borrar=3"  method="post" enctype="multipart/form-data" style="float: left">
      <dl>
    ...
    <form action="grupo1.php"  method="post" enctype="multipart/form-data" style="float: right">
      <dl>
  ...
  <td><table  border="1" width="100%"> 
      ...
      <td><table  border="1" width="100%"> 
       ...
       <tr> 
       	...
       	<td align="center" height="50"><a href=<?php echo"listaedit.php?res=0" . "&nof=" . $nof . "&id=" . $id ?>><b><font size="4"><?php echo $dias[$i]; ?></div></font></b></a></td>
