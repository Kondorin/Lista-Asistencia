...
<?php if($borrar==1){ ?>
  ...
  <form action="grupo3.php?res=3" method="post">
  ...
  <form action="grupo3.php" method="post">
...
<h1 align="center">¿Está seguro de borrar todos los alumnos?</h1>
  <form action="grupo3.php?res=4" method="post">
...
<h1 align="center">¿Está seguro de borrar todas las fechas?</h1>
  <form action="lista3.php?res=2" method="post">
