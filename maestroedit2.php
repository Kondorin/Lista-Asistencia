...
<body>
 ...
 <tr> 
  ...
  <td><table  border="1" width="100%"> 
      ...
      <td><?php echo $row['nombre'] ?><a href="grupo2.php"><img align="right" src="images/cancelar.png" width="20px" height="20px" /></a></td>
      <?php  }else{ ?>
      ...
      <td><table  border="1" width="100%"> 
       <tr> 
        ...
        <?php $not = 0; for ($i=0; $i <$conttareas ; $i++) {   $not = $not +1;?>
           ...
           <?php if ($not== $hw){  ?>
             ...
             <td align="center" bgcolor="red"><?php echo "T" . $not ?><form method="POST"  id="edit" action="<?php echo "grupo2.php?res=5&id=" . $id ."&not=" . $not ?>" > <input type="text" name="notarea" size="1"><input type="submit"  value="Editar" id="edit" ></form></td>
       ...
       <tr> 
          <?php $noe = 0; for ($i=0; $i <3 ; $i++) { $noe = $noe + 1;?>
            ...
            <td align="center" bgcolor="red" width="25"><?php echo $example2[$i] ?><form method="POST"  id="edit" action="<?php echo "grupo2.php?res=6&id=" . $id ."&noe=" . $noe ?>" > <input type="text" name="noexamen" size="1"><input type="submit"  value="Editar" id="edit" ></form> </a> </td> 
