...
<body>
      ...
      <!--botones-->
        ...
        <form action="grupo3.php?res=2"  method="post" enctype="multipart/form-data" margin='0' style="float: left">
      <dl>
    ...
    <form action="borrar3.php?borrar=1" method="post" enctype="multipart/form-data" margin='0' style="float: left">
      <dl>
  ...
  <form action="grupo3.php?res=1" method="post" enctype="multipart/form-data" margin='0' style="float: left">
      <dl>
...
<form action="borrar3.php?borrar=2" method="post" enctype="multipart/form-data" margin='0' style="float: left">
      <dl>
    ...
    <form action="lista3.php"  method="post" enctype="multipart/form-data" margin='0' style="float: right">
      <dl>
      ...
      <td><table  border="1" width="100%"> 
       <tr> 
        ...
        <?php $not = 0; for ($i=0; $i <$conttareas ; $i++) {   $not = $not +1;?>
            <td align="center"><a href=<?php echo"maestroedit3.php?hw=" . $not . "&id=" . $id . "&res=0"?>><?php echo $example[$i] ?></a></td>
       ...
       <tr> 
        <!--IMPRIME EL NUMERO DE EXAMENES DE CADA ALUMNO-->
          <?php for ($i=1; $i <=3 ; $i++) { ?>
            ...
            <td align="center" width="25"><a href=<?php echo "maestroedit3.php?id=" . $id . "&ex=" . $i ?>> <?php echo $example2[$i-1] ?> </a> </td> 
